...
int k;       
    ...
    for (k=0;k<sps;k++){{
            ...
            {{
                ...
                {{
                    ...
                    {{
                        ...
                        else if (y1<{limit_down}f)
                        {{
                            y1=2*({limit_down}f)-y1;
                        }}
                        ...
                        else if (z1<{zlimit_down}f)
                        {{
                            z1=2*({zlimit_down}f)-z1;
                        }}
                        y_i[idx]=y1;
                        z_i[idx]=z1;
                    }}
        ...
        {{
            ...
            x_i[iddd]=rng_uni(&lrng_state)*{L[0]}f;
            y_i[iddd]=rng_uni(&lrng_state)*(fabsf({limit_down}f)+fabsf({limit_up}f))+({limit_down}f);
            z_i[iddd]=rng_uni(&lrng_state)*(fabsf({zlimit_down}f)+fabsf({zlimit_up}f))+({zlimit_down}f);
            indexes[idx]=-1;
        }}
...
print "speed", 2500*256*3000000/elapsed/1e9
